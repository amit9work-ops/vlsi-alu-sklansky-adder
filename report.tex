...
\fig{alu_full_sim_4p33ghz}{0.92}{Full ALU simulated at 1.2\,V near $f_{max}$ (4.33\,GHz target, $T_{cyc}=0.21$\,ns; the corrected worst-case $f_{max}$ from \S\ref{sec:fmax} is 4.27\,GHz): $A$, $B$, $X$, $C$, and $Y$ tracking correctly cycle-to-cycle.}
